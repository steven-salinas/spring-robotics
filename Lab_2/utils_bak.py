...
pwmMapL=[1.473,1.478,1.483,1.488,1.493,1.498,1.503,1.508,1.513,1.518,1.523,1.528,1.533,1.538]
ipsMapL=[-2.4,-1.94,-1.583,-1.123,-0.638,-0.153,0,0,0.1786,0.63,1.123,1.601,2.075,2.45]

pwmMapR=[1.468,1.473,1.478,1.483,1.488,1.493,1.498,1.503,1.508,1.513,1.518,1.523,1.528,1.533]
ipsMapR=[-2.4,-1.94,-1.48,-1.05,-0.613,-0.077,0,0,0.08,0.48,0.89,1.4,1.813,2.25]
...
def getSpeeds():
    ...
    if sum(left_window)==0 or len(left_window)<1:
        ...
        left_speed= (max(len(left_window), 1)/32)/float(sum(left_window)) #calculate speed using formula using total_revolutions/total_time

    if sum(right_window)==0 or len(right_window)<1:
        right_speed=0
    else:
        right_speed= (max(len(right_window), 1)/32)/float(sum(right_window)) #calculate speed using formula using total_revolutions/total_time
